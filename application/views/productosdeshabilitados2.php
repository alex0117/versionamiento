<nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="#1"><h3>Lista de Producto Deshabilitados</h3></a>

            <?php echo form_open_multipart('Productos/empleado');?>
                <button type="submit" class="btn btn-primary">Ver Producto habilitado</button>
                                ...
                                foreach ($producto->result() as $row) 
                                {
                                    ...
                                    <th scope="row"><?php echo $indice;?></th>
                                        ...
                                        <td ><?php
                                            ...
                                            <td>
                                            <?php echo form_open_multipart('Productos/habilitarbd');?>
